...
/*
 * The Global station page gets all of the menu_items that list
 * "global" as their station (by searching through the DemoValues
 * and adding each global item to a new list) and then creates a
